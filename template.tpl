...
[
  {
    ...
    "subParams": [
      ...
      },
      {
        ...
        "selectItems": [],
        "simpleValueType": true,
        "help": "You can pass in dynamic revenue values which will show up in reporting as post-click and post-view revenue",
        "notSetText": "(not set)"
      },
      {
        "type": "SELECT",
        ...
        "selectItems": [],
        "simpleValueType": true,
        "help": "You can include an extra field to pass into your pixel and then see this data in conversion reporting.",
        "notSetText": "(not set)"
      },
      {
        "type": "TEXT",
        "name": "expiration",
        "displayName": "Expiration time for the xandr_token cookie in seconds.",
        "simpleValueType": true,
        "valueValidators": [
          {
            "type": "NON_EMPTY"
